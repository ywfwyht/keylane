'''
Date: 2023-02-09 11:56:15
Author: yang_haitao
LastEditors: yanghaitao yang_haitao@leapmotor.com
LastEditTime: 2023-02-14 08:49:59
FilePath: /K-Lane/home/work_dir/work/keylane/models/backbone/vit.py
'''
"""
...
class EncoderBlock(nn.Module):
    def __init__(self, dim,
        ...
        self.mlp = MLPHead(in_features=dim, hidden_features=mlp_hidden_dim, act_layer=act_layer, drop=drop_ratio)
...
class VisionTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_c=3, num_classes=1000,
                 ...
                 attn_drop_ratio=0., drop_path_ratio=0., embed_layer=None, norm_layer=None, act_layer=None):
        """
        Args:
        ...
        self.rearrage = Rearrange('b (h w) (p1 p2 c) -> b c (h p1) (w p2)',
            h=1152 // 16, p1=16, p2=16)
        self.conv1 = nn.Conv2d(3, 512, kernel_size=2,stride=2,padding=0)
        self.max_pool = nn.MaxPool2d(kernel_size=2)
        self.conv2 = nn.Conv2d(512, 1024, kernel_size=2,stride=2,padding=0)
        self.conv3 = nn.Conv2d(1024, 1024, kernel_size=1)

        self.downsample = nn.PixelUnshuffle(8)
        self.conv = nn.Conv2d(3 * 8**2, 1024, kernel_size=1)
        # self.shared_mlp = nn.Conv2d(in_channels=int(dim/(patch_size**2)), out_channels=1024, kernel_size=1)
...
if __name__=="__main__":
    ...
    model = VisionTransformer(img_size=1152,
                              patch_size=16,
                              embed_dim=768,
                              depth=1,
                              num_heads=12,
